// src/types/staff.ts
// src/types/staff.ts — sirf types rakho, permissions import karo

export type { ModulePermission, PermissionGroup } from "@/lib/staffPermissions";
export {
  MODULE_PERMISSIONS,
...
//   { key: "REPORTS_OCCUPANCY",   label: "Reports — Occupancy",         description: "View room occupancy and availability reports",    group: "Reports", icon: "🛏️" },
