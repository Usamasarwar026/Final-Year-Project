...
export async function updateRoom(
  ...
  if (data.price_per_night !== undefined) payload.price_per_night = new Prisma.Decimal(data.price_per_night);
  ...
  if (data.amenities       !== undefined) payload.amenities       = data.amenities as Prisma.InputJsonValue;
