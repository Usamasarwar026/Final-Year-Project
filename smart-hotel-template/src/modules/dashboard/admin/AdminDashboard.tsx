...
export default function AdminDashboard() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    if (s === "checkedout" || s === "checked-out") {
      return (
        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-50 text-gray-800 border border-gray-100">
          Checked Out
        </span>
      );
    }
  ...
  // Filter trend based on selection
  ...
  return (
    <div className="space-y-8 p-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Real-time operational overview, activities, staff, and financial health.
          </p>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className="text-2xl font-bold text-gray-900 mt-1 block tracking-tight">
                  {kpi.value}
                </span>
              </div>
            </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Left Columns - Activities & Bookings */}
              ...
              <div className="flex bg-gray-100 rounded-lg p-0.5 text-xs font-semibold">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-md transition-all ${
                    revenueDays === 7 ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-900"
                  }`}
                >
                  7 Days
                </button>
                <button
                  ...
                  className={`px-3 py-1.5 rounded-md transition-all ${
                    revenueDays === 30 ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-900"
                  }`}
                >
                  30 Days
                </button>
        ...
        {/* Right Column - Statuses, Inventory, Billing */}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            ...
            <div className="h-[200px] flex items-center justify-center relative">
              ...
              <div className="absolute text-center">
                ...
                <span className="text-[10px] uppercase font-bold text-gray-400 block tracking-wider mt-0.5">Total Rooms</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center p-3 bg-amber-50/50 border border-amber-100/50 rounded-xl">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-amber-700">Low Stock Threshold</span>
                </div>
              ...
              <div className="flex justify-between items-center p-3 bg-gray-50 border border-gray-100 rounded-xl">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-gray-600">Total Catalog Items</span>
                </div>
