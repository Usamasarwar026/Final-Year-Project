...
export const staffNav: NavItem[] = [
  ...
  // nav.config.ts — sirf yeh Reports block replace karo, function same rakho
  // nav.config.ts — Reports block, Kitchen pattern ki tarah
...
export function filterStaffNavByPermissions(
  userPermissions: string[],
): NavItem[] {
  console.log("permission for staff", userPermissions);
