...
import OccupancyReport from "@/modules/reports/components/OccupancyReport";
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="border-b border-gray-100 pb-5">
        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Occupancy Report</h1>
        <p className="text-sm text-gray-500 mt-1">Room occupancy rates and availability analytics</p>
      </div>
