...
import GuestReport from "@/modules/reports/components/GuestReport";
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="border-b border-gray-100 pb-5">
        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Guests Report</h1>
        <p className="text-sm text-gray-500 mt-1">Guest demographics, visits and satisfaction analytics</p>
      </div>
