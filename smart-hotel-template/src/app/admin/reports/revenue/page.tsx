...
import RevenueReport from "@/modules/reports/components/RevenueReport";
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="border-b border-gray-100 pb-5">
        ...
        <p className="text-sm text-gray-500 mt-1">Financial performance and revenue analytics</p>
      </div>
