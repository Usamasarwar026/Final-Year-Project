      ...
      try {
        ...
        if (updated.customer_id) {
          await createNotification({
            ...
            recipient_user_id: String(updated.customer_id),
        ...
        await createNotification({
          ...
          message: `Booking ID ${bookingId} for guest ${updated.customer.name || "Guest"} has been updated to "${status}" by ${session.user.name || "User"}.`,
          type: "booking",
          priority: status === "Cancelled" ? "High" : "Medium",
          module: "booking",
          reference_id: String(bookingId),
        ...
        console.error(
          "[PATCH /api/bookings/[id]] Notification trigger failed:",
          notifErr,
        );
      }
    }
...
export async function DELETE(_req: NextRequest, { params }: Params) {
  try {
    ...
    try {
      ...
      console.error(
        "[DELETE /api/bookings/[id]] Notification trigger failed:",
        notifErr,
      );
    }
